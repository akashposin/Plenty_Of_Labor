...
const Login = ({navigation}) => {
    ...
    const userLogin = async () => {
        try {
            ...
            if (isEmail(email)) {
               // dispatch({ type: actions.account.LOGIN_CALL, payload: data });
            } else {
                Toast.show({
 ...
 * update props data
 * @param state
 * @returns {{connection_status: *, language: ((locale: moment.LocaleSpecifier) => moment.Moment) | (() => moment.Locale) | ((language?: string) => string) | ((language?: string, definition?: moment.Locale) => string) | string, langId: *, notifications: (number|Subject<any>|string|NotificationsModule|(() => RNFirebase.notifications.Notifications)|notifications), offersList: *}}
 */
const mapStateToProps = (state) => {
    return {
        loggedIn: state.accountReducer.loggedIn,
        connection_status: state.accountReducer.connection_status,
    }
};
